        ...
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-12">
            <div className="flex items-center gap-10">
              <a href="tel:2817898836" className="flex items-center gap-2 text-sm font-black uppercase tracking-[0.2em] text-[#0A0E1A] hover:text-[#FF9A00] transition-colors">
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 pb-4 border-t border-slate-200">
            <div className="flex flex-col gap-4 pt-4">
              <a 
                href="tel:2817898836" 
                className="flex items-center gap-2 text-sm font-black uppercase tracking-[0.2em] text-[#0A0E1A] hover:text-[#FF9A00] transition-colors py-2"
              >
                <Phone className="h-5 w-5" />
                (281) 789-8836
              </a>
